...
def printMenu():
    ...
    print("8- Calcular el raiting promedio de libros")
    print("9- Filtrar el catálogo de libros por un rango de calificaciones")
    print("10- Cambiar tipo de algoritmos (resucrsivos o iterativos)")
    print("0- Salir")
...
def menu_cycle():
    ...
    while working:
        ...
        if int(inputs) == 1:
            ...
            isbn = int(isbn)
            result = controller.findBookByISBN(conrol, isbn, recursive=rec)
            delta_time+ f"{result[0]:.3f}"
            book = result[1]
            print("===== El libro encontrado es: =====")
            print("Para econtrar el libro con ISBN", isbn, ",tiempo:", str(delta_time), "[ms]")
            ...
            print("Para",controller.bookSize(control), "elementos, tiempo:", str(delta_time), "[ms]")
